...
| Less Than Equals       | {<key>:{$lte:<value>}}                        | db.tweets.find({"likes":{$lte:50}}).pretty()                    | where likes <= 50                                                                  |
| Greater Than           | {<key>:{$gt:<value>}}                         | db.tweets.find({"likes":{$gt:50}}).pretty()                     | where likes > 50                                                                   |
| Greater Than Equals    | {<key>:{$gte:<value>}}                        | db.tweets.find({"likes":{$gte:50}}).pretty()                    | where likes >= 50                                                                  |
| Not Equals             | {<key>:{$ne:<value>}}                         | db.tweets.find({"likes":{$ne:50}}).pretty()                     | where likes != 50                                                                  |
